...
namespace UnityIsekaiGame.Development.Automation
{
    ...
    public static class PrototypeStep10AutomationSuites
    {
        ...
        private static TestLabAutomationStepResult PositionDefinitionsAndVacancies(TestLabAutomationContext context)
        {
            ...
            PositionEmploymentOperationResult shared = CreatePosition(context, "vacant-clerk", ProfessionContentIds.GuildClerkPositionId, "organization.prototype.adventurers-guild", ProfessionContentIds.GuildOrganizationTypeId, 2);
        ...
        private static TestLabAutomationStepResult PositionCapacityConflictsDutiesAuthority(TestLabAutomationContext context)
        {
            ...
            PositionEmploymentOperationResult clerk = AppointEligiblePerson(context, "duty-clerk", ProfessionContentIds.GuildClerkPositionId, "organization.prototype.adventurers-guild", ProfessionContentIds.GuildOrganizationTypeId, ProfessionContentIds.PositionRestrictedRecordsAuthorityId);
        ...
        private static TestLabAutomationStepResult PositionReportingLifecyclePersistence(TestLabAutomationContext context)
        {
            ...
            PositionEmploymentOperationResult supervisor = AppointEligiblePerson(context, "persistence-supervisor", ProfessionContentIds.ApprenticeSupervisorPositionId, "organization.prototype.adventurers-guild", ProfessionContentIds.GuildOrganizationTypeId, ProfessionContentIds.PositionAppointAuthorityId);
            PositionEmploymentOperationResult clerk = AppointEligiblePerson(context, "persistence-clerk", ProfessionContentIds.GuildClerkPositionId, "organization.prototype.adventurers-guild", ProfessionContentIds.GuildOrganizationTypeId, ProfessionContentIds.PositionRestrictedRecordsAuthorityId);
            ...
            bool authorityEnded = runtime.HasActiveAuthority(runtimes.PersonId, "organization.prototype.adventurers-guild", ProfessionContentIds.PositionRestrictedRecordsAuthorityId);
            ...
            PositionEmploymentOperationResult restore = restored.RestoreFromSaveData(save, runtimes.DefinitionRegistry, runtimes.Professions, runtimes.Training, runtimes.ProfessionalActivities, runtimes.Credentials, runtimes.ProfessionalRanks, runtimes.KnownPersonIds, new[] { "organization.prototype.adventurers-guild", "organization.prototype.royal-forge" }, new[] { "authority.guild.prototype", ProfessionContentIds.PositionAppointAuthorityId, ProfessionContentIds.PositionDutyAssignAuthorityId, ProfessionContentIds.PositionSuperviseAuthorityId }, restoring: true);
            ...
            PositionEmploymentOperationResult rejected = restored.RestoreFromSaveData(corrupt, runtimes.DefinitionRegistry, runtimes.Professions, runtimes.Training, runtimes.ProfessionalActivities, runtimes.Credentials, runtimes.ProfessionalRanks, runtimes.KnownPersonIds, new[] { "organization.prototype.adventurers-guild", "organization.prototype.royal-forge" }, new[] { "authority.guild.prototype", ProfessionContentIds.PositionAppointAuthorityId, ProfessionContentIds.PositionDutyAssignAuthorityId, ProfessionContentIds.PositionSuperviseAuthorityId }, restoring: true);
        ...
        private static TestLabAutomationStepResult CredentialAccessPersistence(TestLabAutomationContext context)
        {
            ...
            string[] authorities = { "authority.guild.prototype", "authority.medical.prototype", "organization.prototype.adventurers-guild" };
        ...
        private static TestLabAutomationStepResult CareerAuthoritativeTransitions(TestLabAutomationContext context)
        {
            ...
            PositionEmploymentOperationResult clerk = AppointEligiblePerson(context, "career-transfer-clerk", ProfessionContentIds.GuildClerkPositionId, "organization.prototype.adventurers-guild", ProfessionContentIds.GuildOrganizationTypeId, ProfessionContentIds.PositionRestrictedRecordsAuthorityId);
            ...
            PositionEmploymentOperationResult target = CreatePosition(context, "career-transfer-target", ProfessionContentIds.IndependentContractorPositionId, "organization.prototype.royal-forge", ProfessionContentIds.IndependentOrganizationTypeId, 2);
            ...
            PositionEmploymentOperationResult dismissedEmployment = AppointEligiblePerson(context, "career-dismiss-clerk", ProfessionContentIds.GuildClerkPositionId, "organization.prototype.adventurers-guild", ProfessionContentIds.GuildOrganizationTypeId, ProfessionContentIds.PositionRestrictedRecordsAuthorityId);
        ...
        private static TestLabAutomationStepResult CareerConcurrentGapsRedaction(TestLabAutomationContext context)
        {
            ...
            PositionEmploymentOperationResult clerk = AppointEligiblePerson(context, "career-secondary-clerk", ProfessionContentIds.GuildClerkPositionId, "organization.prototype.adventurers-guild", ProfessionContentIds.GuildOrganizationTypeId, ProfessionContentIds.PositionRestrictedRecordsAuthorityId);
        ...
        {
            TestLabRuntimeBundle runtimes = context.ScenarioContext.Runtimes;
            PositionEmploymentOperationResult contractor = AppointEligiblePerson(context, "career-retire-contractor", ProfessionContentIds.IndependentContractorPositionId, "organization.prototype.royal-forge", ProfessionContentIds.IndependentOrganizationTypeId, "authority.guild.prototype", EmploymentClassification.IndependentServiceFoundation);
            ...
            PositionEmploymentOperationResult returnEmployment = AppointEligiblePerson(context, "career-return-contractor", ProfessionContentIds.IndependentContractorPositionId, "organization.prototype.royal-forge", ProfessionContentIds.IndependentOrganizationTypeId, "authority.guild.prototype", EmploymentClassification.IndependentServiceFoundation);
        ...
        private static string[] DefaultLifePathOrganizations() => new[] { "organization.prototype.adventurers-guild", "organization.prototype.royal-forge" };

        private static string[] DefaultLifePathAuthorities() => new[] { "authority.guild.prototype", ProfessionContentIds.PositionAppointAuthorityId, ProfessionContentIds.PositionDutyAssignAuthorityId, "organization.prototype.adventurers-guild" };
